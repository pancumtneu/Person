...
pathoffront = 'D:\opencv\opencv-master\data\haarcascades\haarcascade_lowerbody.xml'
    ...
    for i in range(0, len(list)):
        ...
        if os.path.isfile(path):
            ...
            for (x, y, width, height) in faces:
                ...
                cv2.imwrite(r'.\lowerbody\ liu %s.jpg ' % i, im2)  # 路径拼接方法
